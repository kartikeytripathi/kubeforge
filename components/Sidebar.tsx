...
export function Sidebar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden md:flex h-full w-56 flex-col border-r border-surface-600 bg-surface-900 py-4">
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 z-50 flex border-t border-surface-600 bg-surface-900/95 backdrop-blur">
        {NAV_ITEMS.map((item) => {
          const active = pathname.startsWith(item.href);
          return (
            <Link
