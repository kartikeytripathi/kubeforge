type Lesson = { id: string; title: string; status: string; boss?: boolean };
  ...
  const phases: Phase[] = [
    {
      ...
      lessons: [
        { id: "A1", title: "Pods, containers, restartPolicy", status: "locked" },
        { id: "A2", title: "ReplicaSets and Deployments", status: "locked" },
        { id: "A3", title: "Services: ClusterIP, NodePort, LoadBalancer", status: "locked" },
